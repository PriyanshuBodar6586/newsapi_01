...
class Api_Provider extends ChangeNotifier {
  ...
  Articles? Datapick;
  String newslike = "https://newsapi.org/v2/everything?q=Nasa&from=${DateTime.now().year}-${DateTime.now().month}-${DateTime.now().day}&sortBy=publishedAt&apiKey=870ee857647b4b2083a6d45768f26d3a";
