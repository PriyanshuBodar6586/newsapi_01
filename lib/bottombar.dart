...
import 'package:newsapi_01/newsprovider.dart';
...
class _bottomber_ScreenState extends State<bottomber_Screen> {
  List WidgetsList=[api_tabbar(),api_tabbar(),api_tabbar(),api_tabbar(),];
  @override
      ...
      child: Scaffold(
        ...
        bottomNavigationBar:BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(icon:Icon(Icons.flag_sharp),label:"Countery"),
